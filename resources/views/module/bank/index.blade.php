...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title"> List <a href="{{ route('bank.create') }}"><span
                        ...
                        @foreach ($data as $key => $val)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('bank.destroy', $val->id) }}" method="POST">
                                        <a href="{{ route('bank.show', $val->id) }}" class="btn btn-primary "> <i
                                                class="fa-sharp fa-solid fa-magnifying-glass">&nbsp;</i>View</a>
                                        <a href="{{ route('bank.edit', $val->id) }}" class="btn btn-warning"> <i
