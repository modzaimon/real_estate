            ...
            <div class="card-body ">
                <form action="{{ route('estate.store') }}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="number" name="number" placeholder="Enter number" required value="{{old('number')}}">
                      @error('number')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="deed_no" name="deed_no" placeholder="Enter deed_no"  value="{{old('deed_no')}}">
                      @error('deed_no')
                        <span class="invalid-feedback " role="alert" style="display:block">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group-append">
                        <input type="number" class="form-control" id="size" name="size" placeholder="Enter size" value="{{old('size')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="price" name="price" placeholder="Enter price" required value="{{old('price')}}">
                      @error('price')
                        <span class="invalid-feedback " role="alert" style="display:block">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" pattern="\d{4}" maxlength="4" id="build_year" name="build_year" placeholder="Enter Build Year (YYYY)"  value="{{old('build_year')}}">
                    </div>
