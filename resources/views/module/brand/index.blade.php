...
@section('content')
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">List <a href="{{ route('brand.create') }}"><span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('brand.destroy', $val->id) }}" method="POST">
                                        <a href="{{ route('brand.show', $val->id) }}" class="btn btn-primary "> <i
                                                class="fa-sharp fa-solid fa-magnifying-glass">&nbsp;</i>View</a>
                                        <a href="{{ route('brand.edit', $val->id) }}" class="btn btn-warning"> <i
