...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">List <a href="{{ route('customer.create') }}"><span
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('customer.destroy', $val->id) }}" method="POST">
                                        <a href="{{ route('customer.show', $val->id) }}" class="btn btn-primary "> <i
                                                class="fa-sharp fa-solid fa-magnifying-glass">&nbsp;</i>View</a>
                                        <a href="{{ route('customer.edit', $val->id) }}" class="btn btn-warning"> <i
